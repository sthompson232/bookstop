			...
			>
				<div className="relative cursor-pointer inline">
					<input
						...
						ref={ref}
					/>
					<div className="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 peer-checked:bg-accent">
						<div className={classnames("absolute pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out", {
							"translate-x-5": value,
							"translate-x-0": !value,
						})} />
					</div>
